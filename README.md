<div align="center">
  ...
  <p>
    <a href="https://github.com/shivanshSWE-cmd">
      <img src="https://komarev.com/ghpvc/?username=shivanshSWE-cmd&color=6366F1&style=flat-square&label=Profile+Views" alt="Profile Views"/>
    </a>
...
![OSINT](https://img.shields.io/badge/OSINT%20Recon-000000?style=for-the-badge&logo=matrix&logoColor=00FF66)
...
| :--- | :--- | :--- | :--- |
| 🛡️ [**SentinelShield AI**](https://github.com/shivanshSWE-cmd/sentinel-shield-ai) | **SIH 2026 Flagship**: Real-time voice deepfake, phishing & digital arrest defense platform (*Team Neural Defenders*). | `Python` `PyTorch` `FastAPI` `Deepfake AI` | 🚀 Active / Hackathon |
| 📈 [**TradeVision Pro**](https://github.com/shivanshSWE-cmd/tradevision-pro) | Institutional-grade multimodal financial market decoder & neural risk suite. | `JavaScript` `React` `Neural Nets` `Quant` | 🟢 Maintained |
| 📡 [**Bluchart**](https://github.com/shivanshSWE-cmd/Bluchart) | Internet-free Bluetooth P2P encrypted chat app designed for off-grid connectivity. | `React Native` `TypeScript` `BLE` `P2P` | 🟢 Maintained |
| 🗺️ [**Earth OSINT Dashboard**](https://github.com/shivanshSWE-cmd/earth-osint-dashboard) | Interactive geospatial OSINT intelligence & threat visualization dashboard. | `TypeScript` `Geospatial` `React` `OSINT` | 🟢 Maintained |
| 🤖 [**Self-Learning LLM**](https://github.com/shivanshSWE-cmd/self-learning-llm) | Architecture for autonomous self-learning and dynamic continuous fine-tuning LLMs. | `Python` `PyTorch` `Transformers` | 🔬 Experimental |
| 📝 [**VidNote-AI**](https://github.com/shivanshSWE-cmd/VidNote-AI) | Intelligent multimodal video summarization and automated structured note extractor. | `TypeScript` `AI` `NLP` | 🟢 Maintained |
| 🔍 [**ShadowLookup**](https://github.com/shivanshSWE-cmd/shadowlookup) | CLI OSINT exposure analysis tool for email/phone breach intelligence & privacy audits. | `Python` `OSINT` `APIs` `Privacy` | 🟢 Maintained |
| 📜 [**Certi-Flow**](https://github.com/shivanshSWE-cmd/certi-flow) | Automated certificate issuance & verifiable credential generation engine. | `TypeScript` `Node.js` `Workflows` | 🟢 Maintained |
...
- 🔭 I’m currently working on **SentinelShield AI** for Smart India Hackathon 2026.
- 🌱 I’m currently expanding my knowledge in **Deepfake Detection Architectures** & **Quant Risk Models**.
- 👯 I’m open to collaborating on **Cybersecurity, OSINT, and Open Source AI Projects**.
- 💬 Ask me about **Python, AI/ML pipelines, React Native, and OSINT investigation tools**.
- ⚡ Fun fact: I believe offline communication (P2P Bluetooth) is just as essential as hyper-connected cloud systems!
...
<div align="center">
  <sub>Built with ❤️ by Shivansh Mishra (`shivanshSWE-cmd`) | Constantly Innovating & Learning</sub>
</div>
